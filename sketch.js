...
let hOffset;
function setup() {
	ww = window.screen.availWidth - (window.outerWidth - window.innerWidth);
	wh = window.screen.availHeight - (window.outerHeight - window.innerHeight);
...
function draw() {
    ...
    // let today = new Date();
    // textSize(w*0.5);
    // text(today,width/2,height*0.75 + hOffset);
